...
| 특징      | 1. 정해진 데이터 스키마에 따라 테이블에 저장됨.<br />2. 관계를 통해 여러 테이블에 분산됨.<br /><br />3. 조인(JOIN)<br /> | 1. Document 구조<br />2. 다른 구조의 데이터를 같은 컬렉션에 추가 가능함.<br />3. 조인(JOIN) 개념 없음.<br />4. 수평적 확장(서버 추가로 DB 분산시킴) |
...
[링크1]: https://chankim.tistory.com/9

, 

[링크2]: https://velog.io/@bsjp400/Database-DB-%EC%A0%95%EA%B7%9C%ED%99%94-%EB%B9%84%EC%A0%95%EA%B7%9C%ED%99%94%EB%9E%80
